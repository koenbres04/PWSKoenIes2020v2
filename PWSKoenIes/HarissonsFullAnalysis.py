...
output_folder = "HarissonsAnalysisResults"
...
step_size2 = 1e1
minimal_second_gradient = 1e-9  # value of m used for the modified gradient descent algorithm
...
# create an approximation of Harisson's model
